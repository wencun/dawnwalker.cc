...
export default function EditionsPage() {
  return <GuidePage
    ...
    sections={[
      ...
      { title: "What to check if the armor is missing", body: <ol><li>Confirm the retailer or storefront listing included the pre-order bonus for your region.</li><li>Check the platform&apos;s add-on or entitlement list and install any separate bonus item.</li><li>Restart the game after the current update is installed.</li><li>Keep the receipt and original bonus description when contacting the retailer or platform support.</li></ol> },
