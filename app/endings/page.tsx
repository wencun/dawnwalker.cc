...
export default function EndingsPage() {
  return <GuidePage
    ...
    sections={[
      ...
      { title: "Conditions that matter before the final save", body: <div className="fact-grid"><p><b>Time limit</b>Do not let the timer expire if you want the family-rescue outcome. See <Link href="/what-happens-after-30-days">what happens after 30 days</Link>.</p><p><b>Companion progress</b>The cited launch guide links some variations to Lacra or Crake route completion. Finish those quests before the final commitment.</p><p><b>Prologue medicine</b>The launch ending guide also identifies the mother&apos;s medicine choice as relevant to outcomes. Our <Link href="/how-many-spoonfuls-of-herbs">illustrated herbs answer</Link> covers that early decision.</p><p><b>Manual saves</b>Do not rely on an assumed New Game Plus or automatic checkpoint to preserve an alternate branch.</p></div> },
