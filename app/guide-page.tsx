...
export function GuidePage({ eyebrow, title, dek, checked, sections, sources, faqs, nextSteps, nativeAdAfter, showAds = true }: { eyebrow: string; title: string; dek: string; checked: string; sections: GuideSection[]; sources: { label: string; href: string }[]; polishPath?: string; faqs?: { question: string; answer: string }[]; nextSteps?: GuideNextStep[]; nativeAdAfter?: string; showAds?: boolean }) {
