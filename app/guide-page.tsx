...
export function GuidePage({ eyebrow, title, dek, checked, sections, sources, polishPath = "/pl", faqs }: { eyebrow: string; title: string; dek: string; checked: string; sections: GuideSection[]; sources: { label: string; href: string }[]; polishPath?: string; faqs?: { question: string; answer: string }[] }) {
