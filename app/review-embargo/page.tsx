...
export const metadata = guideMetadata(
  "The Blood of Dawnwalker Review Embargo: August 31 Time",
  "The Blood of Dawnwalker review embargo is reported for August 31 at 5 PM CEST. See US, UK, Europe, Japan and Australia times, plus what remains unconfirmed.",
  "/review-embargo",
...
export default function ReviewEmbargoPage() {
  return <GuidePage
    ...
    title="The Blood of Dawnwalker review embargo: August 31 time explained"
    dek="The currently reported review embargo lifts on August 31 at 5:00 PM CEST—three days before release. Here are the local-time conversions, source status and checks to make when reviews appear."
    ...
    sections={[
      ...
      { title: "Are there review scores yet?", body: <><p><b>No verified aggregate score is listed on this page before the reported embargo time.</b> Do not rely on a claimed Metacritic, OpenCritic or “leaked review” score until it can be checked on the aggregator and the original outlet.</p><p>This page will be updated after the embargo with attributable review links rather than copied summaries or unsourced scores.</p></> },
