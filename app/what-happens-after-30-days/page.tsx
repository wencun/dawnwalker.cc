...
export default function AfterThirtyDaysPage() {
  return <GuidePage
    ...
    nextSteps={[
      ...
      { label: "Check New Game Plus status", href: "/new-game-plus", description: "Keep carry-over and postgame questions separate from the day-30 outcome." },
    ]}
    sources={[
    ...
    sections={[
      ...
      { title: "Need a New Game Plus or postgame answer?", body: <p>The day-30 outcome and carry-over status are separate questions. See the dedicated <Link href="/new-game-plus">New Game Plus status guide</Link> for the current release answer, what should not be assumed to transfer, and the pre-finale save plan.</p> },
