...
export default function NewGamePlusPage() {
  return <GuidePage
    eyebrow="NEW GAME PLUS ANSWER · NO NG+ IN THE LAUNCH BUILD"
    ...
    sections={[
      { title: "New Game Plus status: no NG+ after the ending", body: <p><b>No confirmed NG+ mode is available in the launch build.</b> Published launch guides describe returning to the title screen after an ending and using an earlier save for cleanup or another branch. That is different from New Game Plus: it does not establish a new campaign with retained character progress.</p> },
