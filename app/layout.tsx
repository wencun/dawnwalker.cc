...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", siteName: "Dawnwalker Guide", locale: "en_US", title: "The Blood of Dawnwalker Guides: Quest Choices & Fixes", description: "Spoiler-aware quest answers, current gear routes and verified PC fixes.", images: ["/og-seo-refresh.png"] },
  twitter: { card: "summary_large_image", title: "The Blood of Dawnwalker Guides | Dawnwalker Guide", description: "Quest choices, gear routes and verified player fixes.", images: ["/og-seo-refresh.png"] },
