...
export default function ABulwarkAgainstDarknessPage() {
  return <GuidePage
    ...
    sections={[
      ...
      { title: "Bundle of Silk Threads: unlock the correct Sanzhani route", body: <p>Walkthroughs connect Silk Threads to the Sanzhani side-quest chain. Follow <Link href="/help-the-sanzhani">Help the Sanzhani / Letters to Lunka</Link>, then confirm the component in your inventory before returning to the blacksmith. The important answer is not “search every merchant”: advance the Sanzhani chain first, because the relevant reward is tied to its hidden follow-up quests.</p> },
