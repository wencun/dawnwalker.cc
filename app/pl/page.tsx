...
export default function PolishHome() {
  return <main lang="pl">
    <nav className="nav"><a className="brand" href="/pl">DAWNWALKER <span>GUIDE</span><small>NIEOFICJALNY PORADNIK FANOWSKI</small></a><div className="links"><a href="/pl/release-times">Godziny premiery</a><a href="/pl/can-i-run">Czy uruchomię?</a><a href="/pl/console-performance">Konsole</a><a href="/pl/editions">Edycje</a><a href="/pl/time-system">System czasu</a><a href="/pl/known-issues">Znane problemy</a></div></nav>
