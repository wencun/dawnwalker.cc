...
const cards = [
  ...
  ["Latest update", "Blood of Dawnwalker patch notes", "Check the latest official update for shader compilation, stability, saving, quest and Steam GameInput fixes.", "/patch-notes"],
  ...
  ["PC mods", "Best Blood of Dawnwalker mods on Nexus", "Open the live Nexus directory, then use version, dependency and save-safety checks before installing.", "/mods"],
...
export default function Home() {
  return <main>
    ...
    <section className="signal"><span>✦ HOTFIX 1.0.4</span><p>Update first, then retest the exact symptom. Read the <Link href="/patch-notes">official update and patch notes</Link>, use the <Link href="/cant-save">save-lock guide</Link> if saving remains blocked, or follow the controller guide only if the problem persists.</p><Link href="/patch-notes">See what changed →</Link></section>
    <ContentAd />
