...
const cards = [
  ...
  ["Patch 1.0.4", "What did the latest update fix?", "Check the official stability, saving, quest and Steam GameInput changes before trying an old workaround.", "/patch-notes"],
