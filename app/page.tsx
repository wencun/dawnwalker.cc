...
export default function Home() {
  return <main>
    ...
    <section className="signal"><span>✦ LAUNCH STATUS</span><p>Release is confirmed for September 3, 2026. We update facts with dated official sources and label community reports before they become advice. Playing on PC? <a href="/can-i-run">Check the official PC requirements and PC specs</a>.</p><a href="/release-date">Check the release guide →</a></section>
