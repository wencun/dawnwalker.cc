...
export default function Home() {
  return <main><nav className="nav"><a className="brand" href="/">DAWNWALKER <span>GUIDE</span><small>UNOFFICIAL FAN GUIDE</small></a><div className="links"><a href="/release-date">Release date</a><a href="/can-i-run">Can I run it?</a><a href="/console-performance">Performance</a><a href="/editions">Editions</a><a href="/time-system">Time system</a><a href="/known-issues">Issue tracker</a></div></nav>
